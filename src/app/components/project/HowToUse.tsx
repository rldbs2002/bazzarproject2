        ...
        >
          <Card1 sx={{ mb: 4 }}>
            ...
            <Paragraph fontSize="1.2rem" fontWeight={300} mb={5}>
              (14, Yongso-ro, Nam-gu, Busan, Republic of Korea, Busan,
              부산광역시 남구 용소로 14)
            </Paragraph>
            ...
            <Heading number={4} title="Please check if the item has arrived" />
            <Paragraph fontSize="1.2rem" fontWeight={300} mb={5}>
            ...
            <Paragraph fontSize="1.2rem" fontWeight={300} mb={5}>
              Select a service such as shipping, Repacking, and solidate for the
              Request item that arrived, and then add the item to Cart.
            </Paragraph>
            <Paragraph fontSize="1.2rem" fontWeight={300} mb={1}>
            ...
            <Paragraph fontSize="1.2rem" fontWeight={300} mb={5}>
              ...
              volume and weight of the item and the country you want to receive
              it from. After checking the price, check out for payment.
            </Paragraph>
            <Heading
              number={7}
