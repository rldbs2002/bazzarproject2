...
const KRW_TO_USD_RATE = 0.00077;

// KRW를 USD로 변환하는 함수
const krwToUsd = (krwValue: number) => {
  return krwValue * KRW_TO_USD_RATE;
};

// USD를 KRW로 변환하는 함수
const usdToKrw = (usdValue: number) => {
  return usdValue / KRW_TO_USD_RATE;
};
  ...
  const handleFormSubmit = async (values: any) => {
    const requestData = {
      request_info: {
        ...
        delivery_request: values.delivery_request,
        arrived_info: {
